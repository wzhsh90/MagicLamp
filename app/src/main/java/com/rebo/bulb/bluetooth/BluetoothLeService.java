...
public class BluetoothLeService extends Service {
    ...
    //static byte[] Readdata = new byte [6];
    //static byte flag=0;
...
//        		mOnDataAvailableListener.onCharacteristicWrite(gatt, characteristic);
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        // System.out.println("read characterixtic");
    }
    public byte[] readCharacteristic_ByteArray(BluetoothGattCharacteristic characteristic){
        ...
        mBluetoothGatt.readCharacteristic(characteristic);
        if(characteristic == null){ System.out.println("read fail ");return null;}
        else {System.out.println("Read OK");
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        // System.out.println("writer characterixtic");
    }
